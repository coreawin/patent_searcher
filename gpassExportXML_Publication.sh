...
#LIB=.:$GPASS_EXPORT_XML/lib/scopus_rawdata_builder.jar:$GPASS_EXPORT_XML/lib/tqk_common.jar:$GPASS_EXPORT_XML/lib/ojdbc14.jar:$GPASS_EXPORT_XML/lib/activation.jar:$GPASS_EXPORT_XML/lib/tar.jar:$GPASS_EXPORT_XML/lib/je-5.0.104.jar;
