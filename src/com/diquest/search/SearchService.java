...
public class SearchService {
	...
	public ResultSet requestSearch(String ip, int port, QuerySet querySet, boolean printQuery) throws IRException {
		...
		try {
			...
			logger.error("mariner query : {}", querySet.getQuery(0));
...
//			System.exit(-1);
	 ...
	 * @return
	 */
	private static String setCommandSearchRequestProps(String ip, int port) {
		// String log = "search timeout setting 20 minutes";
		// Logger logger = LoggerFactory.getLogger(SearchQueryHelper.class);
		// logger.debug(log);
		CommandSearchRequest.setProps(ip, port, 60 * 60 * 1000, 5, 100);
		return "";
	}
}
